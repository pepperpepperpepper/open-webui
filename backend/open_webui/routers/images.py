...
# NOTE: open_webui.routers.files (upload_file_handler / get_file_content_by_id)
# and open_webui.utils.images.comfyui (ComfyUI* / comfyui_*) are imported
# lazily inside the handlers that use them (fork patch — reduces startup RSS
# and avoids a circular import via routers.files).
